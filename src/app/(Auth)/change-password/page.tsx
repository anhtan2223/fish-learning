...
export default function ChangePasswordPage() {
    ...
    const onFinish = async (values: any) => {
        ...
        try {
            ...
            router.push("/account"); // Redirect to account page after successful password change
        } catch (error) {
    ...
    return (
        <div className="flex justify-center items-center min-h-[calc(100vh-200px)] bg-gray-100 p-4">
